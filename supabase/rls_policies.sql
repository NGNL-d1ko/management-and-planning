...
drop policy if exists "Users can select their own task tags" on public.task_tags;
...
drop policy if exists "Users can update their own task tags" on public.task_tags;
